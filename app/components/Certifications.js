      ...
      <div className="max-w-screen-xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
        <div className="bg-[#14102C] p-6 rounded-lg shadow-lg hover:shadow-xl transform transition-all duration-300 ease-in-out flex flex-col items-center space-y-4 border border-[#232b38]">
          <div className="w-full h-48 overflow-hidden relative">
            <image src="/images/certificates/cer01.svg" alt="Certified Developer" className="w-full h-full object-cover" />
          </div>
        ...
        <div className="bg-[#14102C] p-6 rounded-lg shadow-lg hover:shadow-xl transform transition-all duration-300 ease-in-out flex flex-col items-center space-y-4 border border-[#232b38]">
          <div className="w-full h-48 overflow-hidden relative">
            <image src="/images/certificates/cer01.svg" alt="Advanced Programming Certification" className="w-full h-full object-cover" />
          </div>
          <div className="text-center">
        ...
        <div className="bg-[#14102C] p-6 rounded-lg shadow-lg hover:shadow-xl transform transition-all duration-300 ease-in-out flex flex-col items-center space-y-4 border border-[#232b38]">
          <div className="w-full h-48 overflow-hidden relative">
            <image src="/images/certificates/cer01.svg" alt="Cloud Computing Specialist" className="w-full h-full object-cover" />
          </div>
          <div className="text-center">
